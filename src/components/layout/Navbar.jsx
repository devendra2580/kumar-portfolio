  ...
  return (
    <nav className="w-full bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 sticky top-0 z-50 transition-colors duration-300 relative">
      ...
      <div className="w-full max-w-[95%] mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        >
          <span className="text-blue-600 dark:text-blue-400 font-bold text-3xl tracking-tight">DK</span>
          <span className="text-gray-900 dark:text-white font-bold text-xl">Devendra Kumar</span>
        </div>

        {/* Dynamic View Navigation Links */}
        <div className="hidden md:flex items-center space-x-6 lg:space-x-8 text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300">
          {navItems.map((item) => {
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Download Resume Button with Bouncing Icon */}
          <a
            href="/resume.pdf" 
          ...
          >
            ...
            <div className={`relative w-16 h-8 rounded-full p-1 border transition-colors duration-300 flex items-center justify-between shadow-inner ${
              darkMode 
              ...
              {/* Sun Icon (Left Side) */}
              <div className="w-6 h-6 flex items-center justify-center text-amber-400 z-0">
                <svg className={`w-4 h-4 transition-transform duration-300 ${darkMode ? 'scale-75 opacity-50' : 'scale-100 opacity-100 animate-spin-cw'}`} fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 100 2h1z" clipRule="evenodd" />
                </svg>
              </div>

              {/* Moon Icon (Right Side) */}
              <div className="w-6 h-6 flex items-center justify-center text-cyan-300 z-0">
                <svg className={`w-4 h-4 transition-transform duration-300 ${darkMode ? 'scale-100 opacity-100' : 'scale-75 opacity-50'}`} fill="currentColor" viewBox="0 0 20 20">
                  <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
                </svg>
              </div>

              {/* Sliding Circular Thumb */}
              <div className={`absolute left-1 top-1 w-6 h-6 rounded-full shadow-lg transform transition-transform duration-300 ease-in-out flex items-center justify-center z-10 ${
                darkMode 
